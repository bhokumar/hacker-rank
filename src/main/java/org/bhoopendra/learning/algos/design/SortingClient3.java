...
public class SortingClient3 implements BubbleSort, MergeSort, InsertionSort {

	public static void main(String[] args) {
		SortingClient3 sortingClient2 = new SortingClient3();
		...
		case 2:
			...
			break;
		case 3:
			sortingClient2.mergeSort(arr, 0, arr.length - 1);
			break;
		default:
